...
const idp2 = "https://solid.community/common/popup.html";
const idp3 = "https://solid.community/.well-known/solid/login";
...
export default class App extends Component {
	...
	logIn(idp): Promise<void> {
		return Linking.openURL(idp);
	}
